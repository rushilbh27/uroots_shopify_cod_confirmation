  ...
  const fetchOrderData = async (token: string) => {
    try {
      ...
      setFormData({
        ...
        // alternative phone isn't provided from backend in our flow, keep empty so user can fill
        altPhone: '',
        address: result.data.customer.address,
        city: result.data.customer.city,
        pincode: result.data.customer.pincode
      });
    } catch (err) {
        ...
        >
            ...
            <div className="brand-header-inner">
              ...
              <div className="brand-title-wrap">
                ...
                <p className="brand-subtitle">Order #{orderData.orderId}</p>
              </div>
            </div>
        </div>
              ...
              <div className="shopify-card-section">
                ...
                <div style={{ marginTop: 'var(--space-4)', paddingTop: 'var(--space-4)', borderTop: '1px solid var(--color-border)' }}>
                  ...
                  >
                    ...
                    <span className="text-heading-xl" style={{ fontWeight: 800, fontSize: '1.35rem' }}>₹{orderData.finalAmount.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </div>
